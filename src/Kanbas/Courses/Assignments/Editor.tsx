        ...
        <div id="wd-assignments-editor" className="m-5" style={{ width: '800px' }}>
            <div className="d-felx flex-column p-3 m-3 ">
                ...
                <div className="mb-3 row">
                    <label htmlFor="wd-points" className="col-sm-4 col-formlabel">Points</label>
                ...
                <div className="mb-3 row">
                    <label htmlFor="wd-group" className="col-sm-4 col-formlabel ">Assignment Group</label>
                    <div className="col-sm-8">
                ...
                <div className="mb-3 row">
                    <label htmlFor="wd-display-grade-as" className="col-sm-4 col-formlabel ">
                ...
                <div className="mb-3 row">
                    <label htmlFor="wd-submission-type" className="col-sm-4 col-formlabel ">
                ...
                <div className="mb-3 row">
                    <label htmlFor="wd-assign-to" className="col-sm-4 col-formlabel ">
                        Assign</label>
                    <div className="col-sm-8">
                        <div className="form-control">
                        ...
                        <label htmlFor="wd-available-from" className="col-sm-4">Available from</label>
                        <div className="col-sm-4">
                            <input type="date" className="col-sm-4 form-control m-2 p-0 "
                                id="wd-available-from"
                                value="2024-05-06" />
                        </div>


                        <label htmlFor="wd-available-until" className="col-sm-4">Until</label>
                        <div className="col-sm-4">
                    ...
                    <hr />
                    <div className="text-nowrap d-flex p-0 m-2 justify-content-between">
                    <button id="wd-add-assignment-btn" className="btn btn-xs bg-secondary me-1 float-end">Cancel</button>
                    <button id="wd-add-assignment-btn" className="btn btn-lg btn-danger me-1 float-end">Save</button>
                    </div>
